...
usage: {} [-h] -s SUBDOMAINS [-t Threads] [-o OUTPUT]
...
'''.format(Colors.OKBLUE, Colors.BOLD, Colors.FAIL, Colors.ENDC + Colors.OKBLUE, Colors.BOLD + Colors.FAIL,
           Colors.ENDC + Colors.OKBLUE, nameScript, )
